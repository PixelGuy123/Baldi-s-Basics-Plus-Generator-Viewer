...
internal static class LdStorage // Stores Level Objects
{
	...
	public readonly static LevelObject Floor3 = new(new MinMax<IntVector2>(new(30, 35), new(40, 45)),
		...
		[new(new(new(new(10, 10), new(16, 16)), "Library"), 100), new(new(new(new(12,12),new(18,18)), "Playground"), 100), new(new(new(new(10, 10), new(15, 15)), "Cafeteria"), 100)], // This is messed up lmao
		4,
		6,
		5,
		2,
